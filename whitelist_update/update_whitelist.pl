...
my $dbh_modencode = DBI->connect("dbi:Pg:dbname=modencode_chado;host=heartbroken.lbl.gov", "db_public", "ir84#4nm", { AutoCommit => 0 }) or die "Couldn't get modENCODE database $!";
